    ...
    vec![
        ...
        primitive(
            ...
            exact(vec![
                candidate(),
                TypeConstraint::Exact(quantity(Dimension::Momentum)),
                TypeConstraint::Exact(quantity(Dimension::Dimensionless)),
                candidate(),
            ]),
            DimensionRule::Fixed(quantity(Dimension::Dimensionless)),
            EffectRule::UnionArgs,
        ...
        primitive(
            "system_delta_phi",
            exact(vec![candidate(), candidate()]),
            DimensionRule::Fixed(quantity(Dimension::Dimensionless)),
            EffectRule::UnionArgs,
        ),
        primitive(
            "legacy_lepton_rpt",
            exact(vec![object_set(), object_set(), candidate()]),
            DimensionRule::Fixed(quantity(Dimension::Dimensionless)),
            EffectRule::UnionArgs,
        ),
        primitive(
            "pair_leading_attr",
            exact(vec![candidate(), TypeConstraint::Numeric]),
            DimensionRule::Argument(1),
            EffectRule::UnionArgs,
        ),
        primitive(
            "pair_subleading_attr",
            exact(vec![candidate(), TypeConstraint::Numeric]),
            DimensionRule::Argument(1),
            EffectRule::UnionArgs,
        ),
